...
/**
 * 
 * Class Name:StoreDrugInDetail 入库详细信息
 * 
 * @author 余鑫晨
 * @version (1.0)
 */
public class StoreDrugInDetail {
	/** storeDrugInNo */
	private String storeOrderNo;
	/** storeDrugInDetailId */
	private Integer storeDrugInDetailId;
	/** drugCode */
	...
	public Integer getStoreDrugInDetailId() {
		return storeDrugInDetailId;
	}

	public void setStoreDrugInDetailId(Integer storeDrugInDetailId) {
		this.storeDrugInDetailId = storeDrugInDetailId;
	}
